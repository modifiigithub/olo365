...
export default function Hero() {
    ...
    console.log(bookTableDate, bookTableTime)
            ...
            <div className="modal" role="dialog">
                <div className="modal-box w-11/12 max-w-2xl relative px-10">
                    ...
                    <div className="flex justify-center items-center gap-2 md:gap-6 mt-8">
                        ...
                        <button onClick={() => setBookTable(prev => !prev)} className={`${bookTable ? "bg-base-200" : ""} hover:bg-base-300 w-full h-24 text-xl font-semibold rounded-lg`}>
                            Book Table
                        </button>
                    </div>

                    {bookTable && <div className="mt-5 pb-10">
                        <>
