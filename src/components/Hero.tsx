...
export default function Hero() {
    return (
        ...
        >
            <div className="absolute inset-0 bg-gradient-to-r from-stone-900/50 to-stone-900/40"></div>

            <div className="text-center py-36 text-white z-10">
                <h3 className="text-6xl font-semibold">Indulge in Culinary Delights and </h3>
                <h3 className="text-5xl font-semibold mt-8">Unforgettable Dining Experiences</h3>
